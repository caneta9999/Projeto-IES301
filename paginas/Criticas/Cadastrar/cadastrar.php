...
<body>
    ...
    <form action="php.php" method="POST">
        ...
        <label for="ano">Ano de conclusão da disciplina: </label><input class="inputAnoSemestre" type="number" placeholder="XXXX" name="ano" id="ano" min="1973" max="2100" required> <br />
